...
{ 
    ...
    { 
             Intent intent = null; 
              switch (position) 
              { 
                      case 0:      intent = new Intent(this, HotelActivity.class);               
                                             break; 
                      case 1:       intent = new Intent(this, HotelActivity.class); 
                                         break; 
                      case 2:       intent = new Intent(this, HotelActivity.class);
                                             break; 
                      case 3:       intent = new Intent(this, HotelActivity.class);               
                      						break; 
                      case 4:       intent = new Intent(this, HotelActivity.class); 
                      						break; 
                      case 5:        intent = new Intent(this, HotelActivity.class);
                       						break;                             
                      default:           
                     	 intent = new Intent(this, HotelActivity.class); // Activity_0 as default
...
//                         	fragmentManager.beginTransaction().replace(R.id.frame_container, fragment).commit();                    
                         	...
                         	//mDrawerLayout.closeDrawer(mDrawerList); 
                         	//ntent intent = new Intent(this, act.getClass());
