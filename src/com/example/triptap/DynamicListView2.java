...
import com.example.triptap.tripme.StableArrayAdapter;
 ...
 */
public class DynamicListView2 extends ListView {
    ...
    public DynamicListView2(Context context) {
        super(context);
        init(context);
    }

    public DynamicListView2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public DynamicListView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
