...
@SuppressLint("NewApi")  
  public class Hotel extends Fragment implements OnItemClickListener
  {
	private Button btnSubmit;
	private ArrayList <HotelData> arrMain;
	private ArrayList <HotelData> arrPlan;
	private String TAG =  Hotel.class.getSimpleName();
...
//		};
	...
	{ 
        ...
        //btnSubmit = (Button)rootView.findViewById(R.id.btn_hot);
...
//        pos = getArguments().getInt("position");
        ...
        arrMain = new ArrayList <HotelData>();
        HotelData data;
        for(int i=0; i<arrTitle.length; i++)
        {
        	data = new HotelData();
        	data.setPurl("https://ss3.4sqi.net/img/categories_v2/travel/hotel_bg_64.png");
        ...
        // ListView setUP
        lsvMain = (ListView)rootView.findViewById(R.id.hot_list);
        HotelAdapter adt = new HotelAdapter(getActivity(), arrMain);
...
//        });
	...
	private void makeJsonObjReq() 
	{
		String ur = "https://api.foursquare.com/v2/venues/search?near=" +
				...
				"&client_secret=" +
				Const.CLIENT_SECRET +
				"&categoryId=4bf58dd8d48988d1fa931735&v=20130815";
		showProgressDialog();
				...
				new Response.Listener<JSONObject>() 
				{
					...
					public void onResponse(JSONObject response) 
					{
						...
						try 
						{
							...
							arrPlan = new ArrayList<HotelData>();
							HotelData dat;
							...
							for(int i=0;i<venues.length();i++)
							{
							 ...
							 HotelAdapter hdt = new HotelAdapter(getActivity(), arrPlan);
						     lsvMain.setAdapter(hdt);
						     hdt.notifyDataSetChanged();
