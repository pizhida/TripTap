...
public class ResAdapter extends BaseAdapter 
{
    ...
    Context context;
    List<ResData> rowItem;
	ImageLoader iml;
	DisplayImageOptions dmp;

    ResAdapter(Context context, List<ResData> rowItem) 
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) 
    {
        ...
        if (convertView == null) 
        {
            ...
            lsvItem.tvTitle = (TextView)convertView.findViewById(R.id.res_name);
            lsvItem.tvDistance = (TextView)convertView.findViewById(R.id.res_dis);
            lsvItem.imgView = (ImageView)convertView.findViewById(R.id.res_cat);
            
                                 
            convertView.setTag(lsvItem);
			convertView.setTag(R.id.res_name, lsvItem.tvTitle);
			convertView.setTag(R.id.res_dis, lsvItem.tvDistance);
			convertView.setTag(R.id.res_cat, lsvItem.imgView);
